class Effect:
    ...
    def reapply(self):
        ...
        self.elapsed_time = 0
    def update(self, delta_time: float, target) -> None:
...
class BurnEffect(Effect):
    ...
    def __init__(self, damage:float, duration:float=0) -> None:
...
class SlowEffect(Effect):
    ...
    def __init__(self, duration:float=5, percentage:int=0, amount:float=0) -> None:
...
class Regeneration(Effect):
    ...
    def __init__(self, hps:float, duration:float=0) -> None:
...
class Strength(Effect):
    ...
    def __init__(self, dmg_amount:float=0, dmg_percent:int=0, duration:float=0) -> None:
